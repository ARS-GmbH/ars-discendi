        ...
        <div class="container createOuter">
            <div class="panel panel-dark">
                <div class="panel-heading">
                    <h3>Neue Projektarbeit anlegen</h3>
                </div>
                <div class="panel-body">
					<div class="createInner">
						<form:form method="POST"
							action="/skilldb/users/${user.id}/proofs/projectparticipations/create"
							commandName="projectParticipationHelper" class="form-horizontal"
							role="form">
